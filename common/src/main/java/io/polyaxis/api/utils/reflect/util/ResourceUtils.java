package io.polyaxis.api.utils.reflect.util;

import io.polyaxis.api.utils.misc.ClassUtils;
import io.polyaxis.api.utils.misc.StringUtils;
import io.polyaxis.api.utils.reflect.resource.ClassPathResource;
import io.polyaxis.api.utils.reflect.resource.FileSystemResource;
import io.polyaxis.api.utils.reflect.resource.Resource;
import io.polyaxis.api.utils.reflect.resource.ResourceLoader;
import io.polyaxis.api.utils.reflect.resource.UrlResource;
...
/// [ResourceLoader]'s `getResource()` method can resolve any location
/// to a [Resource] object, which in turn allows one to obtain
/// a [java.io.File] in the file system through its [#getFile(URI)] method.
///
...
public abstract class ResourceUtils {
    ...
    /// Resolve the given resource URL to a [File], i.e. to a file in the file system.
    ///
    ...
    /// Resolve the given resource URI to a [File], i.e. to a file in the file system.
    ///
    ...
    /// Resolve the given resource URI to a [File],
    /// i.e. to a file in the file system.
    ///
    /// @param resourceUri the resource URI to resolve
    /// @param description a description of the original resource that
    ...
    /// Set the [URLConnection#setUseCaches] "useCaches" flag on the
