...
/// with fewer modifications Abstract base class for resources which resolve URLs into File
/// references, such as [UrlResource] or [ClassPathResource].
///
...
public abstract class AbstractFileResolvingResource extends AbstractResource {
    ...
    /// Calls [#useCachesIfNecessary(URLConnection)] and
